            ...
            <div className="content">
                ...
                <div className="text-container">
                    <div className="text">
                        ...
                        <p>ב-<span>YUMI</span>, אנו מאמינים שניהול משרדים אפקטיבי משפיע ישירות על פרודוקטיביות ואווירה במקום עבודה. עם רקע עשיר של מעל לעשור בתחום, חברתנו מספקת פתרונות מותאמים לכל סוגי הארגונים והמבנים. מאחזקה שוטפת ועד ניקיון מקצועי, אנו כאן כדי להבטיח שהמשרד שלכם יהיה יעיל, נקי ומזמין.
                        </p>
                        <p>
